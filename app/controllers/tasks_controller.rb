class TasksController < ApplicationController
  ...
  def create
    ...
    authorize @task
    if @task.save
      redirect_to dashboard_path, notice: "Has creat una tasca nova."
    else
  ...
  def update
    ...
    if @task.update(task_params)
      redirect_to dashboard_path, notice: 'Has actualitzat la tasca.'
    else
  ...
  def destroy
    authorize @task
    @task.destroy
    redirect_to dashboard_path, notice: 'Has esborrat la tasca.'
  end
