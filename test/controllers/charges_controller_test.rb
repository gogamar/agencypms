...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference("Charge.count") do
      post charges_url, params: { charge: { booking_id: @charge.booking_id, description: @charge.description, price: @charge.price, quantity: @charge.quantity } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { booking_id: @charge.booking_id, description: @charge.description, price: @charge.price, quantity: @charge.quantity } }
