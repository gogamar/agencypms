...
ActiveRecord::Schema[7.0].define(version: 2024_05_01_221806) do
  ...
  create_table "cleaning_companies", force: :cascade do |t|
    t.string "name"
  ...
  create_table "rates", force: :cascade do |t|
    ...
    t.integer "arrival_day"
    t.integer "max_advance", default: 365
  ...
  create_table "vragreements", force: :cascade do |t|
    ...
    t.bigint "company_id"
    t.integer "signatory"
    t.boolean "sign_online", default: true
